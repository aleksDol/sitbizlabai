...
1) Человекочитаемый план (solutionOfferText) — живой экспертный текст, без markdown, с эмодзи и CTA в конце.
...
- в solutionOfferText не дублируй блок "Что стоит внедрить", он должен быть только в planCards
...
Текст в solutionOfferText должен соответствовать структуре:
...
Оставьте контакты — покажем, как реализовать под ваш бизнес.
